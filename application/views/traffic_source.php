        ...
        <h1>YouTube Authorization Demo</h1>
            <p>
                ...
                <?php if(isset($connected) && $connected): ?>
                    Authorized. <a href='<?php echo base_url('traffic_source/disconnect'); ?>'>Disconnect</a>
                    ...
                    <!--input type="date" id="dateInput" class="form-control" placeholder="Input Tanggal..."-->
                    ...
                    <button id="toggleMode" class="btn btn-secondary">Toggle Dark Mode</button>
                        ...
                        <div class="container py-5">
                            <div class="text-center">
                                ...
                                <!--p class="text-center"><i class="bi bi-globe-americas"></i> < ?php echo $estimatedRevenuePerDay; ?></p-->
                                <p class="text-center"><i class="bi bi-cash"></i> Total: Rp. <?php echo $totalAllRevenue; ?></p>

                                <form id="filterForm" method="post" action="<?php echo base_url('traffic_source'); ?>">
                                    <div class="row justify-content-center align-items-center">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a class="dropdown-item" onclick="selectChannel('JCC', 'UCIimjC2xJp3Zi6CAr5-TMIg')">JCC</a></li>
                                            <li><a class="dropdown-item" onclick="selectChannel('My Church', 'UColr0xU_CcswUb-6JfYtM3Q')">My Church</a></li>
                                    ...
                                    <div class="col-auto">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item" onclick="selectChannel1('All', 'All')">All</a></li>
                                            ...
                                            <a href="https://www.youtube.com/watch?v=<?php echo htmlspecialchars($video['videoId'], ENT_QUOTES, 'UTF-8'); ?>" class="text-decoration-none" target="_blank">
                                                <div class="card mb-4">
                                                    ...
                                                    <div class="card-body d-flex flex-column">
                                                        ...
                                                        <p class="card-text"><i class="bi bi-eye-fill"></i> Views Age: <?php echo ($video['viewsAge2']); ?></p>
                                                        <p class="card-text"><i class="bi bi-eye-fill"></i> Views Age: <?php echo ($video['viewsAge3']); ?></p>
                                                        <p class="card-text"><i class="bi bi-eye-fill"></i> Views Age: <?php echo ($video['viewsAge4']); ?></p>
                                                        <p class="card-text"><i class="bi bi-eye-fill"></i> Views Age: <?php echo ($video['viewsAge5']); ?></p>
                                                        <p class="card-text"><i class="bi bi-eye-fill"></i> Percentage Age Total: <?php echo ($video['percentageTotal']); ?>%</p>
                                                        <p class="card-text"><i class="bi bi-eye-fill"></i> Percentage Age 1: <?php echo ($video['percentageAge1']); ?>%</p>
                                                        <p class="card-text"><i class="bi bi-eye-fill"></i> Percentage Age 2: <?php echo ($video['percentageAge2']); ?>%</p>
                                                        <p class="card-text"><i class="bi bi-eye-fill"></i> Percentage Age 3: <?php echo ($video['percentageAge3']); ?>%</p>
                                                        <p class="card-text"><i class="bi bi-eye-fill"></i> Percentage Age 4: <?php echo ($video['percentageAge4']); ?>%</p>
                                                        <p class="card-text"><i class="bi bi-eye-fill"></i> Percentage Age 5: <?php echo ($video['percentageAge5']); ?>%</p>
                                                    </div>
                                                </div>
                                            </a>
                                        </div>
...
<!-- <p class="card-text"><i class="bi bi-cash"></i> Views: ${$video.viewSources}</p> -->
<script>
                    ...
                    <a href="https://www.youtube.com/watch?v=${video.videoId}" class="text-decoration-none" target="_blank">
                        <div class="card mb-4">
                            ...
                            <div class="card-body d-flex flex-column">
                                ...
                                <p class="card-text"><i class="bi bi-eye-fill"></i> percentageAge Total : ${video.percentageTotal}%</p>
