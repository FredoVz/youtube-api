...
<body>
    ...
    <button id="toggleMode" class="btn btn-secondary">Toggle Dark Mode</button>
            ...
            <div class="text-center">
                ...
                <form id="filterForm" method="post" action="<?php echo base_url('monetaryy'); ?>">
                            ...
                            <a href="https://www.youtube.com/watch?v=<?php echo htmlspecialchars($video['videoId'], ENT_QUOTES, 'UTF-8'); ?>" class="text-decoration-none" target="_blank">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body d-flex flex-column">
                                        ...
                                        <p class="card-text"><i class="bi bi-eye-fill"></i> Views Age 1: <?php echo ($video['viewsAge1']); ?></p>
                                        <p class="card-text"><i class="bi bi-eye-fill"></i> Views Age 2: <?php echo ($video['viewsAge2']); ?></p>
                                        <p class="card-text"><i class="bi bi-eye-fill"></i> Views Age 3: <?php echo ($video['viewsAge3']); ?></p>
                                        <p class="card-text"><i class="bi bi-eye-fill"></i> Views Age 4: <?php echo ($video['viewsAge4']); ?></p>
                                        <p class="card-text"><i class="bi bi-eye-fill"></i> Views Age 5: <?php echo ($video['viewsAge5']); ?></p>
                                        <p class="card-text"><i class="bi bi-eye-fill"></i> Views Age 6: <?php echo ($video['viewsAge6']); ?></p>
                                        ...
                                        <p class="card-text"><i class="bi bi-eye-fill"></i> Percentage Age 6: <?php echo ($video['percentageAge6']); ?>%</p>
                                        <p class="card-text"><i class="bi bi-eye-fill"></i> Total All Duration: <?php echo ($video['totalAllDuration']); ?> Seconds</p>
                                    </div>
                                </div>
                            </a>
                        </div>
